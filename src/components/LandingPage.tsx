...
export default function LandingPage() {
    ...
    <main className="bg-white text-black">
      ...
      <section className="relative overflow-hidden">
        <div className="flex flex-col items-center px-6 pt-20 text-center">
          {/* Product preview — above the title, like Codex */}
          <div className="mb-16 w-full max-w-[1100px]">
            <WorkbenchPreview />
          </div>

          <h1 className="text-[56px] font-medium leading-[1.0] tracking-[-0.035em] text-black sm:text-[72px] lg:text-[88px]">
            ftre
          </h1>

          <div className="mt-5 max-w-[560px]">
            <p className="text-[17px] leading-[28px] text-black/70">
          ...
          <p className="mt-4 pb-24 text-[13px] text-black/40">
            可用平台：Windows · macOS · Linux
          </p>
        </div>
      </section>

      {/* Features — large gradient images, alternating layout */}
      <section id="features" className="px-6 py-40">
        <div className="mx-auto max-w-[1200px]">
          <h2 className="mb-24 text-center text-[36px] font-medium tracking-[-0.03em] text-black sm:text-[48px]">
            为实际工程任务的核心需求而打造
          </h2>
      ...
      {/* Config + Architecture */}
      <section className="border-t border-black/[0.06] px-6 py-40">
        <div className="mx-auto max-w-[1200px]">
          <div className="grid items-center gap-20 lg:grid-cols-2">
            <div>
              <h2 className="text-[36px] font-medium tracking-[-0.03em] text-black sm:text-[48px]">
                开箱即用
              </h2>
            ...
            <div className="overflow-hidden rounded-2xl border border-black/[0.08] bg-[#fafafa] shadow-sm">
              ...
              <pre className="overflow-x-auto p-5 text-[14px] leading-7 text-black/80"><code>{`{
  "llm": {
    "model": "deepseek-chat",
  ...
  "max_iterations": 10
      ...
      <section className="border-t border-black/[0.06] px-6 py-40">
        <div className="mx-auto max-w-[1200px]">
          <h2 className="mb-6 text-center text-[36px] font-medium tracking-[-0.03em] text-black sm:text-[48px]">
            一个工作台，覆盖完整开发流程
          </h2>
          <p className="mb-20 text-center text-[17px] leading-[28px] text-black/60">
...
function FeatureRow({
  ...
  const textCol = (
    <div className="flex flex-col justify-center">
      ...
      <p className="mt-4 max-w-[460px] text-[17px] leading-[28px] text-black/60">{desc}</p>
    </div>
  )

  const visualCol = (
    <div className="flex items-center justify-center">
      <div className={`h-[480px] w-full rounded-3xl bg-gradient-to-br ${gradient}`}>
        <div className="flex h-full items-center justify-center">
          <div className="h-24 w-24 rounded-3xl bg-white/50 shadow-sm backdrop-blur-sm" />
        </div>
      </div>
    </div>
  )
        ...
        <div className="flex min-w-0 flex-col">
          ...
          <div className="flex-1 space-y-5 px-6 py-6">
            ...
            <div className="max-w-[86%]">
              ...
              <div className="rounded-2xl rounded-tl-md border border-black/[0.06] px-4 py-3 text-[14px] leading-6 text-black/70">
                改好了。产品预览在标题上方，渐变块 480px 高，交替布局，section 间距 160px。
              </div>
            </div>
          </div>
